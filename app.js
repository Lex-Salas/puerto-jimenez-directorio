...
const I18N={
  es:{
    ...
    transport_daily:'todos los días', transport_no_sunday:'sin servicio los domingos', transport_mon_fri:'Lun–Vie', transport_sat:'Sáb', transport_mon_fri_long:'Lunes a viernes', transport_saturday:'Sábado', transport_sunday:'Domingo', transport_outbound:'Desde Puerto Jiménez', transport_inbound:'Hacia Puerto Jiménez',
    transport_sj_note:'Duración aproximada: 6–8 horas. Las salidas adicionales dependen de la demanda; confirmá al comprar.',
    transport_san_isidro_note:'Duración aproximada: 2 horas 35 minutos. Sale de la Terminal TRACOPA en San Isidro.', transport_neily_note:'Servicio con muchas paradas; reservá suficiente tiempo para el recorrido.', transport_local_note:'Estos son los períodos de operación. Consultá el PDF para ver paradas y próximas salidas.',
    transport_buy_ticket:'Comprar tiquete', transport_buy_passer:'Comprar con PASSER', transport_view_source:'Ver fuente', transport_route_stops:'Horario y paradas',
    transport_no_official_schedule:'Sin horario oficial confirmado', transport_community_schedule:'Horario comunitario · confirmar antes de viajar', transport_boat_source_note:'Horario aportado por la comunidad. El aviso de la imagen fue publicado en 2021; confirmá cada viaje y los días feriados por WhatsApp.', transport_boat_warning:'ARESEP informa que, al 30 de julio de 2026, la ruta no tiene un operador autorizado por el MOPT. Por eso este horario no se presenta como oficial vigente.', transport_confirm_whatsapp:'Confirmar por WhatsApp', transport_official_notice:'Ver aviso oficial',
  ...
  en:{
    ...
    transport_daily:'daily', transport_no_sunday:'no Sunday service', transport_mon_fri:'Mon–Fri', transport_sat:'Sat', transport_mon_fri_long:'Monday to Friday', transport_saturday:'Saturday', transport_sunday:'Sunday', transport_outbound:'From Puerto Jiménez', transport_inbound:'To Puerto Jiménez',
    transport_sj_note:'Approximate duration: 6–8 hours. Extra departures depend on demand; confirm when purchasing.',
    transport_san_isidro_note:'Approximate duration: 2 hours 35 minutes. Departs from the TRACOPA terminal in San Isidro.', transport_neily_note:'This service makes many stops; allow enough time for the journey.', transport_local_note:'These are operating windows. Open the PDF for stops and upcoming departures.',
    transport_buy_ticket:'Buy ticket', transport_buy_passer:'Buy with PASSER', transport_view_source:'View source', transport_route_stops:'Schedule and stops',
    transport_no_official_schedule:'No confirmed official schedule', transport_community_schedule:'Community schedule · confirm before traveling', transport_boat_source_note:'Schedule provided by the community. The notice in the image was published in 2021; confirm every trip and public holidays by WhatsApp.', transport_boat_warning:'ARESEP reports that, as of July 30, 2026, this route has no MOPT-authorized operator. Therefore this schedule is not presented as currently official.', transport_confirm_whatsapp:'Confirm by WhatsApp', transport_official_notice:'View official notice',
  ...
  fr:{
    ...
    transport_daily:'tous les jours', transport_no_sunday:'aucun service le dimanche', transport_mon_fri:'Lun–Ven', transport_sat:'Sam', transport_mon_fri_long:'Du lundi au vendredi', transport_saturday:'Samedi', transport_sunday:'Dimanche', transport_outbound:'Depuis Puerto Jiménez', transport_inbound:'Vers Puerto Jiménez',
    ...
    transport_san_isidro_note:'Durée approximative : 2 h 35. Départ du terminal TRACOPA à San Isidro.', transport_neily_note:'Ce service effectue de nombreux arrêts ; prévoyez assez de temps.', transport_local_note:'Il s’agit des plages de service. Consultez le PDF pour les arrêts et les prochains départs.',
    transport_buy_ticket:'Acheter le billet', transport_buy_passer:'Acheter avec PASSER', transport_view_source:'Voir la source', transport_route_stops:'Horaires et arrêts',
    transport_no_official_schedule:'Aucun horaire officiel confirmé', transport_community_schedule:'Horaire communautaire · à confirmer avant le voyage', transport_boat_source_note:"Horaire fourni par la communauté. L’avis de l’image date de 2021 ; confirmez chaque trajet et les jours fériés par WhatsApp.", transport_boat_warning:"Selon l’ARESEP, au 30 juillet 2026, cette liaison n’a pas d’opérateur autorisé par le MOPT. Cet horaire n’est donc pas présenté comme officiellement en vigueur.", transport_confirm_whatsapp:'Confirmer par WhatsApp', transport_official_notice:"Voir l’avis officiel",
  ...
  de:{
    ...
    transport_daily:'täglich', transport_no_sunday:'sonntags kein Betrieb', transport_mon_fri:'Mo–Fr', transport_sat:'Sa', transport_mon_fri_long:'Montag bis Freitag', transport_saturday:'Samstag', transport_sunday:'Sonntag', transport_outbound:'Ab Puerto Jiménez', transport_inbound:'Nach Puerto Jiménez',
    ...
    transport_san_isidro_note:'Ungefähre Fahrzeit: 2 Stunden 35 Minuten. Abfahrt am TRACOPA-Terminal in San Isidro.', transport_neily_note:'Dieser Bus hält sehr häufig; genügend Reisezeit einplanen.', transport_local_note:'Dies sind die Betriebszeiträume. Haltestellen und nächste Abfahrten stehen im PDF.',
    transport_buy_ticket:'Ticket kaufen', transport_buy_passer:'Mit PASSER kaufen', transport_view_source:'Quelle ansehen', transport_route_stops:'Fahrplan und Haltestellen',
    transport_no_official_schedule:'Kein bestätigter offizieller Fahrplan', transport_community_schedule:'Community-Fahrplan · vor der Fahrt bestätigen', transport_boat_source_note:'Fahrplan aus der Community. Der Hinweis im Bild stammt aus 2021; jede Fahrt und Feiertage per WhatsApp bestätigen.', transport_boat_warning:'Laut ARESEP hat diese Route zum 30. Juli 2026 keinen vom MOPT zugelassenen Betreiber. Dieser Fahrplan wird daher nicht als aktuell offiziell dargestellt.', transport_confirm_whatsapp:'Per WhatsApp bestätigen', transport_official_notice:'Offiziellen Hinweis ansehen',
